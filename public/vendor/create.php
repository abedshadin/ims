        ...
        <div class="col-lg-8 col-xl-7">
            <div class="card shadow border-0">
                <div class="card-body p-4 p-lg-5">
                    ...
                    <form id="vendorForm" method="post" data-endpoint="files_store.php" data-reset-on-success="true" data-open-file-url="../files/show.php?file=" novalidate>
                        <div class="row g-4">
                            <div class="col-12">
                            ...
                            <div class="col-md-6">
                                <label class="form-label text-uppercase small fw-semibold" for="brand">Brand</label>
                        ...
                        <div class="mt-4 d-flex flex-column flex-sm-row gap-2">
                            ...
                            <a class="btn btn-outline-secondary btn-lg" href="index.php">Back to Vendors</a>
                        </div>
                    </form>
                </div>
            </div>
